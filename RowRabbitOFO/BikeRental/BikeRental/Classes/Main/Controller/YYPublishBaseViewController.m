...
@interface YYPublishBaseController ()<UICollectionViewDelegate,UICollectionViewDataSource,JJPhotoDelegate,XWImagePickerSheetDelegate>{
...
@implementation YYPublishBaseController

static NSString * const reuseIdentifier = @"YYPhotoCell";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UINib *nib = [UINib nibWithNibName:@"YYPhotoCell" bundle: [NSBundle mainBundle]];
    [collectionView registerNib:nib forCellWithReuseIdentifier:@"YYPhotoCell"];
    // Set up the reuse identifier
    YYPhotoCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier: @"YYPhotoCell" forIndexPath:indexPath];
...
- (void) tapProfileImage:(UITapGestureRecognizer *)gestureRecognizer{
    ...
    if (index == (_imageArray.count)) {
        ...
        //点击放大查看
        YYPhotoCell *cell = (YYPhotoCell*)[_pickerCollectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:index inSection:0]];
...
- (void)deletePhoto:(UIButton *)sender{
    ...
    for (NSInteger item = sender.tag; item <= _imageArray.count; item++) {
        YYPhotoCell *cell = (YYPhotoCell*)[self.pickerCollectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:item inSection:0]];
