...
-(void)example01
{
    ...
    [XHLaunchAd setWaitDataDuration:2];//请求广告数据前,必须设置,否则会先进入window的RootVC
    ...
    [Network getLaunchAdImageDataSuccess:^(NSDictionary * response) {
        ...
        model.openUrl = @"";
        model.content = @"http://zc.51xytu.com/launch/share.jpg";
        //配置广告数据
        ...
        imageAdconfiguration.imageOption = ShowFinishAnimateNone;
        //图片填充模式
...
-(void)example02
{
    ...
    //广告图片URLString/或本地图片名(.jpg/.gif请带上后缀)
    imageAdconfiguration.imageNameOrURLString = @"share.jpg";
    //图片填充模式
    imageAdconfiguration.contentMode = UIViewContentModeScaleToFill;
    //广告点击打开链接
    imageAdconfiguration.openURLString = @"http://zc.51xytu.com/launch/";
    //广告显示完成动画
    imageAdconfiguration.showFinishAnimate =ShowFinishAnimateFadein;
    //广告显示完成动画时间
    imageAdconfiguration.showFinishAnimateTime = 0.8;
