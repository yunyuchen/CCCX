...
#define UIColorCurrent [UIColor colorWithHexString:@"#315FC6"]
...
#pragma mark - NavigationBar
    ...
    //QMUICMI.navBarBarTintColor = [UIColor qmui_colorWithHexString:@"#FFFFFF"];                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    ...
    QMUICMI.navBarTitleFont = UIFontBoldMake(12);                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    ...
    [[QMUINavigationTitleView appearance] setHorizontalTitleFont:[UIFont boldSystemFontOfSize:17]];
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarTintColor = [UIColor qmui_colorWithHexString:@"#2CB6AB"];      // TabBarTintColor : UITabBar 的 tintColor
